...
const buttonVariants = cva(
	"flex items-center justify-center border font-medium enabled:cursor-pointer transition-all duration-150 focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring/50 focus:ring-0 disabled:pointer-events-none disabled:opacity-50 [&>svg]:mr-1.5 [&>svg]:opacity-60 [&>svg+svg]:hidden",
	{
		variants: {
			variant: {
				primary:
